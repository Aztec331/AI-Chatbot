...
console.log("\nMessages array of current chat:");
console.log(messages);

const chatIdAtSendTime = 4;

const chatAtSendTime = chats.find((chat) => chat.id === chatIdAtSendTime);
const previousMessages = chatAtSendTime
  ? chatAtSendTime.messages.slice(-10)
  : [];

console.log("\nFull messages in chat 4:");
console.log(chatAtSendTime ? chatAtSendTime.messages : []);

console.log("\nLast 10 messages sent with slice(-10):");
